...
@Component({
  selector: 'app-view-vernier',
  templateUrl: './view-vernier.component.html',
  styleUrls: ['./view-vernier.component.css']
})
export class ViewVernierComponent implements OnInit
{
