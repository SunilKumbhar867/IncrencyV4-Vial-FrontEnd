...
@Component({
  selector: 'app-add-user-ldap',
  templateUrl: './add-user-ldap.component.html',
  styleUrls: ['./add-user-ldap.component.css']
})
export class AddUserLdapComponent implements OnInit
{
  hide1: any;
  hide2: any;
  bln_loading: boolean;
